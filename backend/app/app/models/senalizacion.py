...
class Senalizacion(Base):
    ...
    tipo_senal: Mapped[str] = mapped_column(String(120), nullable=False)
    estado: Mapped[str] = mapped_column(String(100), nullable=False)

    ubicacion_especifica: Mapped[str | None] = mapped_column(String(255), nullable=True)
